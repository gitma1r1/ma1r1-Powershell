...
```text
/ (Root)
├── 💼 01_Work_Admin     			                #📂 BMD, Azure, PRTG, SQL
...
│   │   └── 🛡️ Get-Dreieckszahl-Gauss.ps1   	#ermittelt Gausszahl
│   │   └── 🛡️ Get-JosephusAnswer.ps1   	    #ermittelt Gausszah
│   │   └── 🛡️ make_a_screenshoot.ps1   	    #ermittelt Gausszah
│   │   └── 🛡️ Mesuare-command.ps1   	    	  #ermittelt Gausszah
│   │   └── 🛡️ SimpleClock.ps1   	    	      #ermittelt Gausszah
│
